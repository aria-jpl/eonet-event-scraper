...
LD_LIBRARY_PATH=$HOME/conda/lib:/usr/lib:/usr/lib64:/usr/local/lib:$LD_LIBRARY_PATH ${DIR}/submit_eonet_query.py --lookback_days ${max_eonet_curation_delay} --polygon ${whole_world_polygon} --version $branch